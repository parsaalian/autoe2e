...
export const SignIn: React.FC<SignInProps> = ({
	...
	return (
		...
		>
			<FormProvider form={form} formid="f-signin">
				<div className="grid grid-cols-1 gap-3">
					<TextInput
						...
						clickId="t9-checkout-sign-in-email"
					/>
					<PasswordInput name="password" label="Password" required clickId="t10-checkout-sign-in-password" />
					<div className="flex w-full flex-row items-center justify-end">
						<Button
							...
							clickId="c32-checkout-sign-in-reset-password"
						/>
						<Button
							type="submit"
							...
							clickId="c31-checkout-sign-in-submit"
						/>
					</div>
				</div>
			</FormProvider>
